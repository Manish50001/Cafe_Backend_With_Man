...
import com.man.cafe.dto.ProductDao;
import com.man.cafe.service.ProductService;
...
public class ProductServiceImpl implements ProductService {
	...
	private boolean validateProduct(Map<String, String> requestMap, boolean validateId) {
		...
		if (requestMap.containsKey("categoryId") && requestMap.containsKey("name") && requestMap.containsKey("description") && requestMap.containsKey("price")) { 
			
			if (validateId && requestMap.containsKey("id")) { return true; } 
	...
	public ResponseEntity<List<ProductWrapper>> getByCategory(Integer id) {
		...
		try {
			return new ResponseEntity<>(productDao.getByProdcutCategory(id),HttpStatus.OK);
		}catch (Exception e) {
			e.printStackTrace();
		}
